...
Проект представляет собой объектно-ориентированную модель системы управления заказами в кофейне, реализованную на C# с применением принципов SOLID.
...
- **Принципы SOLID**: Полное соблюдение принципов объектно-ориентированного программирования
- **Паттерн Декоратор**: Для гибкого добавления дополнений к напиткам
- **Инкапсуляция**: Защита внутреннего состояния объектов
- **Полиморфизм**: Единый интерфейс для различных типов продуктов и сотрудников
...
# СЦЕНАРИЙ 1: Простой заказ
------------------------------
# Добавлено: Эспрессо (S - 250мл.) x1

# ЗАКАЗ #1 (Статус: Created)
========================================
  Эспрессо (S - 250мл.) x1 - 100 руб

  ИТОГО: 100 руб
========================================

# КАССИР Елизавета начинает обработку заказа #1
  Принята оплата: 100 руб
# Статус заказа #1 изменен: Created → Paid
  Кассир Елизавета передал заказ #1 бариста

# БАРИСТА Илья начинает готовить заказ #1
# Статус заказа #1 изменен: Paid → InProgress
  Приготовление напитков...
  Добавление добавок...
# Статус заказа #1 изменен: InProgress → Ready
  Бариста Илья завершил приготовление заказа #1
# Статус заказа #1 изменен: Ready → Completed
```
